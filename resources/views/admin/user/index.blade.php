...
@section('content')
    <style>
        ...
        .update-btn-wraper button,
        .refresh-btn-wraper button {
            outline: none;
            border-radius: 30px;
            border: none;
            padding: 13px 30px;
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <ul class="nav nav-pills justify-content-start">
                                <li class="nav-item">
                                    <a class="nav-link active" id="Chat-tab" data-toggle="pill" href="#Chat"
                                        aria-expanded="true">Chat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="MyAds-tab" data-toggle="pill" href="#MyAds"
                                        aria-expanded="false">My Ads</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="NewAd-tab" data-toggle="pill" href="#NewAd"
                                        aria-expanded="false">New Ad</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="Notes-tab" data-toggle="pill" href="#Notes"
                                        aria-expanded="false">Notes</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="Chat" aria-labelledby="Chat-tab"
                                    aria-expanded="true">
                                    <p>Chat</p>
                                </div>
                                <div class="tab-pane" id="MyAds" role="tabpanel" aria-labelledby="MyAds-tab"
                                    aria-expanded="false">
                                    <div class="refresh-btn-wraper" style='text-align:end'>
                                        <button> <svg style='fill:white;' xmlns="http://www.w3.org/2000/svg" height="1em"
                                ...
                                <div class="tab-pane" id="NewAd" role="tabpanel" aria-labelledby="NewAd-tab"
                                    aria-expanded="false">
                                                        ...
                                                        <div class="card-content">
                                                            <div class="card-body">
                                                                <form action="#" class="steps-validation wizard-circle">
                                                                    <!-- Step 1 -->
                                                                    <h6><i class="step-icon feather icon-home"></i> General
                                                                    </h6>
                                                                    <fieldset>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select
                                                                                        ...
                                                                                        <option value="Amsterdam">Chicago
                                                                                        </option>
                                                                                        <option value="Berlin">San
                                                                                            Francisco</option>
                                                                                        <option value="Frankfurt">Boston
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <!-- Step 2 -->
                                                                    <h6><i class="step-icon feather icon-briefcase"></i>
                                                                        Requirements</h6>
                                                                    <fieldset>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                    ...
                                                                    <!-- Step 3 -->
                                                                    <h6><i class="step-icon feather icon-image"></i>
                                                                        Additional</h6>
                                                                    <fieldset>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                ...
                                <div class="tab-pane" id="Profile" role="tabpanel" aria-labelledby="Profile-tab"
                                    ...
                                    <div class="update-btn-wraper" style='text-align:end'>
                                        <button> <svg style='fill:white;' xmlns="http://www.w3.org/2000/svg"
                                                height="1em"
                                                viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                <path
                                                    d="M105.1 202.6c7.7-21.8 20.2-42.3 37.8-59.8c62.5-62.5 163.8-62.5 226.3 0L386.3 160H336c-17.7 0-32 14.3-32 32s14.3 32 32 32H463.5c0 0 0 0 0 0h.4c17.7 0 32-14.3 32-32V64c0-17.7-14.3-32-32-32s-32 14.3-32 32v51.2L414.4 97.6c-87.5-87.5-229.3-87.5-316.8 0C73.2 122 55.6 150.7 44.8 181.4c-5.9 16.7 2.9 34.9 19.5 40.8s34.9-2.9 40.8-19.5zM39 289.3c-5 1.5-9.8 4.2-13.7 8.2c-4 4-6.7 8.8-8.1 14c-.3 1.2-.6 2.5-.8 3.8c-.3 1.7-.4 3.4-.4 5.1V448c0 17.7 14.3 32 32 32s32-14.3 32-32V396.9l17.6 17.5 0 0c87.5 87.4 229.3 87.4 316.7 0c24.4-24.4 42.1-53.1 52.9-83.7c5.9-16.7-2.9-34.9-19.5-40.8s-34.9 2.9-40.8 19.5c-7.7 21.8-20.2 42.3-37.8 59.8c-62.5 62.5-163.8 62.5-226.3 0l-.1-.1L125.6 352H176c17.7 0 32-14.3 32-32s-14.3-32-32-32H48.4c-1.6 0-3.2 .1-4.8 .3s-3.1 .5-4.6 1z" />
                                ...
                                <div class="tab-pane" id="Notes" role="tabpanel" aria-labelledby="Notes-tab"
                                    ...
                                    <div class="save-btn-wraper text-center">
                                        <button class='save-btn'>
                                            <img src="{{ asset('app-assets/images/user/save.png') }}"
                                                alt="png">Save</button>
                                    </div>
                                </div>
                            </div>
